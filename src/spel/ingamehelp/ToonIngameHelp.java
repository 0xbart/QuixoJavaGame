...
public class ToonIngameHelp extends Task {
    ...
    public ToonIngameHelp(JFrame spelFrame, String strSpeler1, String strSpeler2, String strTypeSpeler1, String strTypeSpeler2, int[] spelData){
    ...
    private void execute() {
        ...
        spelFrame.setContentPane(new IngameHelp(spelFrame, strSpeler1, strSpeler2, strTypeSpeler1, strTypeSpeler2, spelData));
        spelFrame.validate();
    }
